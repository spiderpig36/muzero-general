...
class MuZeroConfig:
    def __init__(self):
        env = gym.make("compiler_env/CompilerEnv-v0")
...
class Game(AbstractGame):
    ...
    def step(self, action):
        ...
        return numpy.reshape(numpy.array(observation), (1, 1, self.env.observation_space.shape[0])), reward, terminated or truncated
    ...
    def reset(self):
        ...
        return numpy.reshape(numpy.array(observation), (1, 1, self.env.observation_space.shape[0]))
